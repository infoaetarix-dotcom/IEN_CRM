...
import { regenerateUploadLink } from '@/app/(admin)/applications/actions';
...
/** Copy + regenerate controls for an application's student document-upload link. */
export function UploadLinkCard({
  ...
  function handleRegenerate() {
    ...
    setError(null);
    start(async () => {
      const res = await regenerateUploadLink(applicationId);
